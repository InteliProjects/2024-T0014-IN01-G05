...
class Cand4Final extends Phaser.Scene {
  constructor() {
    super({ key: "Cand4Final"});
  }
  ...
  preload() {
    ...
    this.load.image("cand4Final", "src/assets/mecanica3/candidato2.png");
    this.load.image("statsCand4Final", "src/assets/mecanica3/StatsCandidato4Final.png");
  ...
  create() {
    ...
    candidato1 = this.add
      .image(gameState.larguraJogo / 2, gameState.alturaJogo / 1.5, "cand4Final")
      .setScale(1);
