...
class LinkReclameF3 extends Phaser.Scene {
    constructor() {
        super({ key: "LinkReclameF3" });
    }

    // Carregando as imagens
    preload() {
        this.load.image("pagReclameF3", "././src/assets/mecanica2/Fornecedor_3_img/fornecedor3_reclame.png");
    ...
    create() {
        ...
        reclameF3 = this.add.image(gameState.larguraJogo / 2, gameState.alturaJogo / 1.17, "pagReclameF3");
