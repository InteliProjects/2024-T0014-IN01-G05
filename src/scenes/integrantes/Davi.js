...
class Davi extends Phaser.Scene {
    constructor() {
      super({ key: "Davi" });
    }
    ...
    preload() {
      this.load.image("fundoEmailD", "././src/assets/DaviInstagram.png");
    ...
    create() {
      ...
      this.add
        .image(gameState.larguraJogo / 2, gameState.alturaJogo / 2, "fundoEmailD")
        .setScale(1.3);
