...
class Cand3 extends Phaser.Scene {
  constructor() {
    super({ key: "Cand3" });
  }
  ...
  preload() {
    ...
    this.load.image("statsCand3", "src/assets/mecanica3/StatsCandidato3.png");
    this.load.image("voltar", "src/assets/mecanica3/voltar2.png");
    ...
    this.load.image("respostaErrada", 'src/assets/mecanica3/balaoErro3.png');
  ...
  create() {
    ...
    candidato1 = this.add
      .image(gameState.larguraJogo / 2, gameState.alturaJogo / 1.5, "cand3")
      .setScale(1);
