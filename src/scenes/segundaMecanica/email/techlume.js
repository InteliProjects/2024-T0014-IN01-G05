class Techlume extends Phaser.Scene {
  constructor() {
    super({ key: "Techlume" });
  }
  ...
  preload() {
    ...
    this.load.image("respostaTech", "././src/assets/respostaTechLume.png");
  ...
  create() {
    ...
    this.add.image( gameState.larguraJogo / 1.59, gameState.alturaJogo / 1.35, "respostaTech" ).setScale(1.0);
