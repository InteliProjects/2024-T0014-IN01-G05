...
class LinkBancoFF extends Phaser.Scene {
    constructor () {
        super({ key: "LinkBancoFF"});
    }

   // Carregando as imagens
   preload() {
    this.load.image("pagBancoF1" ,"././src/assets/mecanica2/Fornecedor_1_img/fornecedor1_bancoFF.png");
...
create() {
    ...
    bancoF1 = this.add.image(gameState.larguraJogo/2, gameState.alturaJogo/1.17, "pagBancoF1").setScale(1.39); 
