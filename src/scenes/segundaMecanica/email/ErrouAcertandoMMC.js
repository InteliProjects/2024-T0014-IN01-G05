class ErrouMMC extends Phaser.Scene {
  constructor() {
    super({ key: "ErrouMMC" });
  }
  ...
  preload() {
    this.load.image("fundoEmail4", "././src/assets/feedbackerrommc.png");
  ...
  create() {
    ...
    this.add.image(gameState.larguraJogo / 2, gameState.alturaJogo / 2, "fundoEmail4").setScale(1.2);
