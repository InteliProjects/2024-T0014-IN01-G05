...
class Cand2 extends Phaser.Scene {
  constructor() {
    super({ key: "Cand2" });
  }
  ...
  preload() {
    ...
    this.load.image("statsCand2", "src/assets/mecanica3/StatsCandidato2.png");
    ...
    this.load.image("respostaErrada", 'src/assets/mecanica3/balaoErro2.png');
  ...
  create() {
    ...
    candidato1 = this.add
      .image(gameState.larguraJogo / 2, gameState.alturaJogo / 1.5, "cand2")
      .setScale(1);
