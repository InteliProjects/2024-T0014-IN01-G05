...
class Ibiapina extends Phaser.Scene {
    constructor() {
      super({ key: "Ibiapina" });
    }
    ...
    preload() {
      this.load.image("IbiapinaFoto", "././src/assets/IbiapinaInstagram.png");
    ...
    create() {
      ...
      this.add
        .image(gameState.larguraJogo / 2, gameState.alturaJogo / 2, "IbiapinaFoto")
        .setScale(1.3);
