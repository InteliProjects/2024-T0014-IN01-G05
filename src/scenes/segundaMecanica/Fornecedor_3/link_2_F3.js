...
class LinkBancoF3 extends Phaser.Scene {
    ...
    preload() {
        this.load.image("pagBancoF3" ,"././src/assets/mecanica2/Fornecedor_3_img/fornecedor3_banco.png");
        this.load.image("setaDeVolta", "././src/assets/mecanica2/Fornecedor_3_img/setaDeVolta.png");
        this.load.image("bolaSeta" , "././src/assets/mecanica2/Fornecedor_3_img/bolaSeta.png");  
