...
class Fernando extends Phaser.Scene {
    constructor() {
      super({ key: "Fernando" });
    }
    ...
    preload() {
      this.load.image("fundoEmailF", "././src/assets/FernandoInstagram.png");
    ...
    create() {
      ...
      this.add
        .image(gameState.larguraJogo / 2, gameState.alturaJogo / 2, "fundoEmailF")
        .setScale(1.3);
