...
class Murilo extends Phaser.Scene {
    constructor() {
      super({ key: "Murilo" });
    }
    ...
    preload() {
      this.load.image("fundoEmailM", "././src/assets/MuriloInstagram.png");
    ...
    create() {
      ...
      this.add
        .image(gameState.larguraJogo / 2, gameState.alturaJogo / 2, "fundoEmailM")
        .setScale(1.3);
