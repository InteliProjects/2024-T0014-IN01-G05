class MMC extends Phaser.Scene {
  constructor() {
    super({ key: "MMC" });
  }
  ...
  preload() {
    ...
    this.load.image("respostaMMC", "././src/assets/respostaMMC.png");
  ...
  create() {
    ...
    this.add.image( gameState.larguraJogo / 1.59, gameState.alturaJogo / 1.35, "respostaMMC" ).setScale(1.0);
