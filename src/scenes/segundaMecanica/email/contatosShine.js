class ContatosShine extends Phaser.Scene {
    constructor() {
      super({ key: "ContatosShine" });
    }
    ...
    create() {
      ...
      this.add
        .image(gameState.larguraJogo / 2, gameState.alturaJogo / 2, "fundoEmail").setScale(1.2);
      this.setaDeVolta = this.add
        .image(gameState.larguraJogo / 14, gameState.alturaJogo / 24.2, "voltar")
        .setScale(0.4);
      this.escrever = this.add
        .image(gameState.larguraJogo / 11, gameState.alturaJogo / 4, "escrever")
        .setScale(0.25);
      this.add
        .image(gameState.larguraJogo / 9, gameState.alturaJogo / 2.9, "entrada")
        .setScale(0.3);
      this.favoritos = this.add
        .image(gameState.larguraJogo / 9, gameState.alturaJogo / 2.4, "estrela")
        .setScale(0.3);
      this.add
        .image(gameState.larguraJogo / 9, gameState.alturaJogo / 2.05, "adiados")
        .setScale(0.3);
      this.fornecedor1 = this.add
        .image(
          gameState.larguraJogo / 1.6,
          gameState.alturaJogo / 3,
          "contato1"
        )
        .setScale(0.9);
      this.fornecedor2 = this.add
        .image(
          gameState.larguraJogo / 1.6,
        ...
        .setScale(0.9);
      this.fornecedor3 = this.add
        .image(
          gameState.larguraJogo / 1.6,
          gameState.alturaJogo / 2.1,
          "contato3"
        )
        .setScale(0.9);
