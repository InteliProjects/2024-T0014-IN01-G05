...
class Mateus extends Phaser.Scene {
    constructor() {
      super({ key: "Mateus" });
    }
    ...
    preload() {
      this.load.image("fundoEmailMMM", "././src/assets/MateusInstagram.png");
    ...
    create() {
      ...
      this.add
        .image(gameState.larguraJogo / 2, gameState.alturaJogo / 2, "fundoEmailMMM")
        .setScale(1.3);
